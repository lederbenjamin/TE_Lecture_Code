...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		//option2
		String[] emptyArray = new String[names.size()];
		String[] namesArray2 = names.toArray(emptyArray);
		for(int i = 0; i < namesArray2.length; i++) {
			System.out.println(namesArray2[i]);
		}
		
		//option 3
//		String[] namesArray3 = (String[]) names.toArray();
//		for(int i = 0; i < namesArray3.length; i++) {
//			System.out.println(namesArray3[i]);
//		}
