...
public class JDBCCityDAO implements CityDAO {
	...
	// JdbcTemplate documentation: https://docs.spring.io/spring/docs/4.3.21.BUILD-SNAPSHOT/javadoc-api/
	...
	private long getNextCityId() {
		// TODO: You will need to create this sequence in order for this to work 
		// CREATE SEQUENCE seq_city_id START 5000;
