...
public class Examples {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 && Conditional AND
		   	If operand on the left returns FALSE, it returns FALSE  without evaluating the rest
		 */
		result = true && true;
		...
		/*
		 ||  Conditional OR
		 	...
		 	If the operand on the left returns true, it returns true without evaluating the operand on the right.
		...
		//show different paths based on changing condition1 and 2 values.
